...
.\.agents\skills\indexing-awareness\scripts\index-structure.ps1

# Limit the search depth (default: 4).
.\.agents\skills\indexing-awareness\scripts\index-structure.ps1 -Depth 6

# Limit the search range.
.\.agents\skills\indexing-awareness\scripts\index-structure.ps1 -TargetDir src\
```
...
.\.agents\skills\indexing-awareness\scripts\trace-dependencies.ps1 -Target src\utils\auth.ts

# Symbol mode: search for definitions and usages.
.\.agents\skills\indexing-awareness\scripts\trace-dependencies.ps1 -Target handleLogin

# Limit the search range.
.\.agents\skills\indexing-awareness\scripts\trace-dependencies.ps1 -Target UserService -SearchDir src\
```
...
Verifies the consistency between rules, workflows, and skills in `.agents/` and the descriptions in `README.md`.

```powershell
.\.agents\skills\indexing-awareness\scripts\verify-structure.ps1
```
